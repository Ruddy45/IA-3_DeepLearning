...
enum message_type
{
	...
	Msg_YouHitMe, // Message utilisé par le leader pour définir une cible
	Msg_TargetToAttack, // Définie la cible à attaquer par le leader
	Msg_EncircleEnemy // Stratégie d'encerclement d'une cible définie
};
...
inline std::string MessageToString(int msg)
{
  ...
  case Msg_TargetToAttack:

	  return "Msg_TargetToAttack";

  case Msg_EncircleEnemy:

	  return "Msg_EncircleEnemy";
