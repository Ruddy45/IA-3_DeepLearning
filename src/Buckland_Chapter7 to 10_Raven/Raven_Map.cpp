...
//----------------------- AddTeamWeapon_Giver ----------------------------------
//------------------------------------------------------------------------------
void Raven_Map::AddTeamWeapon_Giver(int type_of_weapon, std::string nameTeam, Vector2D pos, double radius, int GraphNodeIndex)
{
	Trigger_WeaponGiver* wg = new Trigger_WeaponGiver(nameTeam, pos, radius, GraphNodeIndex);
