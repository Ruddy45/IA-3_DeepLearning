...
public:
  ...
  // Nom de la team si l'objet appartient à une équipe
  ...
  void SetNameTeam(std::string newNameTeam) { m_sNameTeam = newNameTeam; } // Définie une team à un objet
  std::string GetNameTeam() { return m_sNameTeam; } // Donne le nom de la team de l'objet
  bool		  IsInATeam() { return m_sNameTeam != ""; } // Si l'objet appartient à une team
};
