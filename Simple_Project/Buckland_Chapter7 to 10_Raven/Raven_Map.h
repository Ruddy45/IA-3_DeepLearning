...
public:
  ...
  // Crée une arme pour les membres de sa team s'il en a une
  void								 AddTeamWeapon_Giver(int type_of_weapon, std::string nameTeam, Vector2D pos, double radius, int GraphNodeIndex);
};
