...
Trigger_WeaponGiver::Trigger_WeaponGiver(std::string nameTeam, Vector2D pos, double radius, int GraphNodeIndex) :

	Trigger_Respawning<Raven_Bot>(GetNextValidID(), false)
